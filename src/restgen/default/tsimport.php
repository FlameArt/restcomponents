...
<?= $GeneratedFieldsStr ?>
     ...
     * @returns
     */
    static async one(IDOrWhere: { <?= implode(", ", $AllTypesGETFields) ?> } | number | string, fields: {<?= implode(", ", $AllTypesGETFields) ?>} | Array<string> | null = null): Promise<<?= $controllerClass ?>|null> {
